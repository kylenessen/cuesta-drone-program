...
The framing for the curriculum is important. Part 107 is the only certification students are required to earn in Cuesta's courses. The ASPRS credential is an optional pursuit after the class, and not an immediate one, because certification requires three years of work experience before a candidate can sit the exam. The curriculum goal is that a graduate who chooses to pursue it a few years into their career finds the exam content familiar, because the mapping course taught toward the same body of knowledge.
