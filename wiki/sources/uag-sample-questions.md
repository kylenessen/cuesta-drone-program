...
The original PDF is preserved in this folder as `uag-sample-questions.pdf`, downloaded 2026-07-02 from the FAA at https://www.faa.gov/sites/faa.gov/files/training_testing/testing/test_questions/uag_questions.pdf.

## Extraction Quality

Machine-extracted text is preserved as `uag-sample-questions.txt`. Question text extracts cleanly, but the questions reference figures from the FAA Airman Knowledge Testing Supplement (FAA-CT-8080-2) that are not included in either file.
