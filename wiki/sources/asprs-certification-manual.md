...
The original PDF is preserved in this folder as `asprs-certification-manual.pdf`, downloaded 2026-07-10 from ASPRS at https://www.asprs.org/common/Uploaded%20files/Public/ASPRS_Certification_Manual.pdf. This is the copy linked from the ASPRS Certification Program page at https://www.asprs.org/certification. The document is undated internally, so claims from it should be treated as current as of the download date.

## Extraction Quality

Machine-extracted text is preserved as `asprs-certification-manual.txt`. Extraction is complete and readable. The fee table and the examination matrices survive with their column structure legible, though the Scientist recertification PDH table loses some alignment. Consult the PDF for the tables if precision matters.
