...
title: FAA-S-ACS-10B
description: FAA Airman Certification Standards for the Remote Pilot Certificate with sUAS rating, defining every knowledge element on the Part 107 test.
tags: []
timestamp: 2026-07-02T17:00:00Z
aliases: [UAS ACS, Remote Pilot ACS]
---
...
The original PDF is preserved in this folder as `faa-s-acs-10b.pdf`, downloaded 2026-07-02 from the FAA at https://www.faa.gov/training_testing/testing/acs/uas_acs.pdf.

## Extraction Quality

Machine-extracted text is preserved as `faa-s-acs-10b.txt`. Extraction is complete and readable, though table layouts (acceptable test materials, certificate application paths) lose their column structure. Consult the PDF for the tables.
