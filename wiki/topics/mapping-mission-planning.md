...
## Planning as a graded discipline

The program teaches this planning chain through a documented preflight planning assignment built for real client missions, with the Morro Bay National Estuary Program restoration monitoring partnership as its working example [9]. Before anyone flies, each student writes a complete mission plan: airspace verification including LAANC authorization where needed and a check for temporary flight restrictions, a survey of hazards and obstacles within five miles of the site such as airports and power lines, the planned polygon with flight path overlay, overlap percentages, altitude, speed, and lane direction, takeoff and landing locations, expected battery consumption with field charging plans, a weather assessment for the flight window, visual observer assignment where applicable, ground control point placement, and parcel ownership research to determine who grants site access. The rubric's core demand is justification. Why this overlap, why this altitude, why this launch point. Because planning is a negotiation among competing constraints, the reasoning matters as much as the numbers, and a written plan can be graded and corrected before the aircraft ever leaves the ground [9]. The exercise ends the way professional work does, with students drafting the methods section of a technical report documenting the flight, so the plan and its execution become a deliverable a real client can use. The pattern generalizes beyond the NEP: any partner mission gets the same justify-every-decision treatment, which is what separates flying a site from planning a mission.
...
[9] NEP collaboration lab activity concept, pre-flight planning assignment (curriculum-content/nep-collaboration-lab.md in this repository).
