...
## Thermal care for equipment and pilot

Batteries, controllers, and tablets suffer in direct sun. Keep spare batteries shaded in an insulated container, never on a dashboard or dark truck bed, and let a hot battery cool before charging, since DJI limits charging to 5 to 40 C [1]. The pilot is equipment too. Shade, water, and sun protection keep judgment sharp through a long mapping day, and degraded pilot attention is a bigger risk than any single hardware failure.
...
- [Weather Effects on Performance](/topics/weather-effects-on-performance.md) and [Aviation Weather Sources](/topics/aviation-weather-sources.md) for the weather knowledge behind go/no-go calls.
