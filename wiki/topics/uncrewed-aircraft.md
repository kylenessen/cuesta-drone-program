...
The terminology is still settling. The same machine is called a drone, a UAV (uncrewed or unmanned aerial vehicle), or a UAS (uncrewed or unmanned aircraft system, meaning the airframe plus its control link and ground station). The FAA's regulatory language in [Part 107](/regulations/part-107.md) uses "small unmanned aircraft system," while much of the current literature has shifted from "unmanned" toward "uncrewed." The preferred nomenclature is worth confirming before it is taught as settled, since it continues to evolve. [1]

## Airframe and Payload

For hobby flying the aircraft is the point. First-person-view (FPV) drones and toys are flown for the experience itself. Professional drones are different. They exist to carry something useful, so it helps to separate the airframe, the flying platform, from the payload, the equipment attached to it that does the actual work. A working drone is a way to lift a sensor or other payload into the sky and bring back its measurements. The range of payloads and the sensor types they represent are covered in [Drone Payloads](/topics/drone-payloads.md). [1]
...
- [Drone Payloads](/topics/drone-payloads.md) covers what professional drones carry and the passive and active sensor types.
- [Remote Sensing Platforms](/topics/remote-sensing-platforms.md) places drones among the other platforms that lift sensors aloft.
