...
Thermal imaging from drones serves two major employment sectors: infrastructure inspection and public safety operations. California's utility inspection requirements (General Orders 95 and 165) create ongoing demand for drone-equipped thermal inspectors, while fire departments, law enforcement, and search and rescue teams increasingly integrate thermal drones into their operations. This course builds on AERO 100 to teach infrared theory, thermal camera operation, image interpretation, and professional reporting workflows applicable across both sectors. The course also prepares students for Level 1 thermography certification, an industry credential that significantly enhances employment prospects. San Luis Obispo County's utility infrastructure, fire risk, and active public safety agencies provide immediate employment context for graduates.

### Catalog Description

Prepares students to conduct professional drone-based thermal imaging and inspection operations. Covers infrared theory, thermal camera operation, data interpretation, and inspection workflows for infrastructure and public safety applications. Students learn to identify thermal anomalies in electrical systems, building envelopes, and solar installations, and to apply thermal imaging to search and rescue and fire assessment operations. Emphasizes professional reporting, safety protocols for operations near energized equipment and emergency scenes, and integration with incident command structures. Course content aligns with Level 1 thermography certification requirements.
...
- **Budget:** Yes
  - **Justification:** Requires DJI Matrice 4T with thermal payload, thermal calibration targets, and heat sources for training scenarios. Software costs for thermal analysis tools. [DISCUSS: funding from SWF money via Lexie, equipment overlap with AERO 110]
- **Facilities:** Yes
  - **Justification:** Requires access to buildings and infrastructure for inspection exercises. Night operations for SAR exercises require suitable outdoor areas with controlled access. Indoor space for thermal physics demonstrations.
- **Equipment:** Yes
  - **Justification:** Requires DJI Matrice 4T with thermal payload, thermal calibration targets, heat sources for training, and laptop with thermal analysis software. Program already has two DJI drones in possession.
- **Staffing:** Yes
