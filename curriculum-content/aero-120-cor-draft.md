...
3. **DE/hybrid:** Distance Education is now drafted as Yes, Blended (lecture online, labs face to face), following Ron's hybrid direction and the AERO 100 DE section. Note: the July advisory outline presents the course as in-person lecture and lab, with scheduling outside standard work hours for incumbent workers. Reconcile the delivery mode before submission.
