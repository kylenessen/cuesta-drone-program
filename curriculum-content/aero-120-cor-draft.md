...
Working draft for CurriQunet submission, structured to match the approved AERO 100 All Fields report section by section. Course number and title are placeholders pending Ron's input. Updated July 2026 to reflect the current course design: inspection-focused, planned around the PG&E and IBEW 1245 partnership, teaching the full Level 1 thermography body of knowledge so students finish prepared to complete certification. Public safety operations have moved to a separate future course. The current advisory-facing outline is curriculum-content/aero-120-advisory-course-outline.md.
...
[TBD - possible options include Infraspection Institute course materials or the ITC Level 1 coursebook, but these are typically bundled with certification programs rather than sold separately. Selection connects to the provider pathway decision (ITC versus Infraspection) for Level 1 certification.]
...
- **Is a material fee recommended for this course?** [TBD]
...
3. **DE/hybrid:** Distance Education is drafted as Yes, Blended (lecture online, labs face to face), following Ron's hybrid direction and the AERO 100 DE section. This is administrative flexibility, a contingency in case in-person instruction is disrupted, not the planned delivery. The course runs in person, as the advisory outline states, and the hybrid option is not advisory committee material.
4. **Thermography certification pathway:** The course teaches the full Level 1 body of knowledge, and the advisory outline promises students finish ready to complete certification. Unlike Part 107 there is no neutral government exam; certification runs through private providers. The open decision is the provider pathway (ITC, Infraspection, or an arrangement through the partnership), which drives the textbook choice.
